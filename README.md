...
<div align="center"> 
  <img src="imagenes/python.png" width="250">
</div>
...
```py
import time
import sys  #python tiene un limite de recursion, importando sys se puede cambiar.
sys.setrecursionlimit(200000)  #Para amplia el límite se usa sys.setrecursionlimit(numero_limite).
...
def busqueda_lineal(lista, objetivo):
    ...
    for elemento in lista: # O(n) #O(n). la función def sería O de 1, y el loop for, al tomar un dato input "lista" califica como O de n que crece lineal.
...
<div align="center"> 
  <img src="imagenes/binary-and-linear-search-animations.gif" width="70%">
</div>
...
<div align="center"> 
  <img src="imagenes/linear-vs-binary-search-worst-case.gif" width="70%">
</div>
...
<div align="center"> 
  <img src="imagenes/linear-vs-binary-search-best-case.gif" width="70%">
</div>
...
<div align="center"> 
  <img src="imagenes/bubble-sort.gif" width="80%">
</div>
...
def ordenamiento_de_burbuja(lista):
    n = len(lista) #len recorre la lista
...
<div align="center"> 
  <img src="imagenes/merge-sort.gif" width="60%">
</div>
...
<div align="center"> 
  <img src="imagenes/grafico.svg" width="80%">
</div>
...
Al correr en VSCode es importante verificar que esté seleccionado el ambiente virtual correcto que posea la librería Bokeh instalada en el ambiente virtual, y asegurarse de desactivar algún tipo de ambiente virtual global, por ejemplo de ananconda.
...
<div align="center"> 
  <img src="imagenes/backpack-problem.png" width="40%">
</div>
